 ...
 *									    *
 ****************************************************************************/
long FAR PASCAL OwnComboWndProc (HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
 ...
 *									    *
 ****************************************************************************/
BOOL FAR PASCAL ListBoxExample (HWND hDlg, unsigned message, WORD wParam, LONG lParam)
 ...
 *									    *
 ****************************************************************************/
BOOL FAR PASCAL ComboBoxExample(HWND hDlg, unsigned message, WORD wParam, LONG lParam)
{
	...
	case WM_COMMAND:
		...
		case ID_UNSLBUTTON:
			...
			SendMessage (hWndCombo, (UINT)CB_SETCURSEL,(WPARAM) -1, 0L);
		...
		case ID_CPYBUTTON:
			...
			wCount = (WORD)SendMessage (hWndCombo, CB_GETLBTEXTLEN, wIndex, 0L);
			SendMessage (hWndCombo,
				     CB_GETLBTEXT,
				     wIndex,
				     (LONG)(LPSTR)strSingleEditLine);
 ...
 *									    *
 ****************************************************************************/
BOOL FAR PASCAL OwnerComboBoxExample (HWND hDlg, unsigned message, WORD wParam, LONG lParam)
