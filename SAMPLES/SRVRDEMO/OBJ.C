 ...
 *
 */
OLESTATUS FAR PASCAL ObjDoVerb 
 ...
 *
 */
OLECLIPFORMAT FAR PASCAL ObjEnumFormats
 ...
 *
 */
OLESTATUS FAR PASCAL ObjGetData
 ...
 *
 */
LPVOID FAR PASCAL ObjQueryProtocol 
 ...
 *
 */
OLESTATUS FAR PASCAL ObjRelease (LPOLEOBJECT lpoleobject)
{
   int i;
 ...
 *
 */
OLESTATUS FAR PASCAL ObjSetBounds (LPOLEOBJECT lpoleobj, LPRECT lprect)
{
 ...
 *
 */
OLESTATUS FAR PASCAL ObjSetColorScheme 
 ...
 *
 */
OLESTATUS FAR PASCAL ObjSetData 
 ...
 *
 */
OLESTATUS FAR PASCAL ObjSetTargetDevice (LPOLEOBJECT lpoleobject, HANDLE hdata)
{
    if (hdata == NULL)
    {
 ...
 *
 */
OLESTATUS FAR PASCAL ObjShow (LPOLEOBJECT lpoleobject, BOOL fTakeFocus)
{
    LPOBJ lpobj;
    HWND hwndOldFocus;
