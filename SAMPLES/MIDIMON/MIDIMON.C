...
//!!    HPEN hPen;
    ...
    static short wChar, hChar;
    static short maxClientWidth;
    static short wClient, hClient;
    ...
    switch(message)
    {
        case WM_CREATE:
            ...
            maxClientWidth = LOWORD(GetTextExtent(hDC, szDisplayTextBuffer,
        ...
        case WM_PAINT:
            ...
            if(ps.rcPaint.top < hChar)
            {
                TextOut(ps.hdc, wChar * (0 - nHscrollPos),
                        ...
                        sprintf(szDisplayTextBuffer, LABEL));
                MoveTo(ps.hdc, wChar * (0 - nHscrollPos), hChar - 1);
 ...
 * Return:  void
 */
void CommandMsg(hWnd, wParam, lParam)
HWND hWnd;
WORD wParam;
LONG lParam;
{
    ...
    switch (wParam) {
        ...
        case IDM_SENDTOMAPPER:
            ...
            if(hMapper) {
                ...
                DoMenuItemCheck(hWnd, wParam, FALSE);
            }
        ...
        case IDM_FILTCHAN14:
        case IDM_FILTCHAN15:
            filter.channel[wParam - IDM_FILTCHAN0] = 
                !filter.channel[wParam - IDM_FILTCHAN0];
            DoMenuItemCheck(hWnd, wParam, 
                filter.channel[wParam - IDM_FILTCHAN0]);
            break;
 ...
 * Return:  void
*/
void DoMenuItemCheck(HWND hWnd, WORD wMenuItem, BOOL newState)
{
    HMENU hMenu;
