 ...
 *  MODULE	: PpFind.c	    					   *
 *									   *
 *  PURPOSE	: Code to do text searches in penpad. 		   *
 *									   *
...
BOOL FAR PASCAL FindDlgProc(HWND,WORD,WORD,LONG);    /* Prototype */ 
...

{
    ...
    /* Give a message */
    PPError (hwndFrame, MB_OK | MB_ICONEXCLAMATION, IDS_CANTFIND, (LPSTR)szSearch);
